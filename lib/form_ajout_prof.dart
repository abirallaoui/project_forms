...
import 'form_ajout_prof_model.dart';
export 'form_ajout_prof_model.dart';



class FormProfWidget extends StatefulWidget {
  const FormProfWidget({super.key});

  @override
  State<FormProfWidget> createState() => _FormWidgetState();
}

class _FormWidgetState extends State<FormProfWidget> {
  late FormProfModel _model;
  ...
  FormProfModel createModel(BuildContext context, FormProfModel Function() builder) {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormProfModel());
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        child:    Text('Ajouter le professeur',
                          style:  TextStyle(
